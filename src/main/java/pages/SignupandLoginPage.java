...
public class SignupandLoginPage {
    ...
    private final By verificationMessage = By.xpath("//div[@class = 'login-form']/h2");
    ...
    public void enterNameandEmail() {
        ...
        driver.findElement(email).sendKeys("Cat");
        driver.findElement(signUp).click();
    }

    public void enterAccountinfo() {
        String message;
        driver.findElement(verificationMessage).getText();
